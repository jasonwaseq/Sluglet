  ...
  const listings = [
    {
      ...
      description:
        "Beautiful apartment located in the heart of Mars Colony. Perfect for space explorers!",
      city: "Mars Colony",
      state: "Red Planet",
      price: 1500,
    ...
    },
    {
      ...
      description:
        "Contemporary studio apartment with amazing views of the Martian landscape.",
      city: "Downtown Mars",
      state: "Red Planet",
      price: 1200,
    ...
    },
    {
      ...
      description:
        "Exclusive penthouse with panoramic views of the entire Mars landscape.",
      city: "Mars Heights",
      state: "Red Planet",
      price: 3000,
